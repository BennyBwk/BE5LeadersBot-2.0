...
.HTML()
.markup((m) => m.inlineKeyboard([
  m.callbackButton('🗒 Attendance', 'main_public_menu:attendance'),
  m.callbackButton('🎉   Events', 'main_public_menu:events'),
  m.callbackButton('🔈 Broadcast', 'main_public_menu:broadcast_message'),
  m.callbackButton('⚙️  Settings', 'main_public_menu:settings')
], {columns: 2}));
...
.HTML()
.markup((m) => m.inlineKeyboard([
  m.callbackButton('🗒 View Attendance', 'attendance_menu:view_attendance'),
  m.callbackButton('📝 Add Attendance', 'attendance_menu:add_attendance'),
  m.callbackButton('🕑 Past Attendance', 'attendance_menu:past_attendance'),
  m.callbackButton('🚫 Remove Attendance', 'attendance_menu:remove_attendance'),
  m.callbackButton('⬅️ Back', 'attendance_menu:backBtn')
], {columns: 2}));
...
.HTML()
.markup((m) => m.inlineKeyboard([
  m.callbackButton('🔔 Notifications', 'settings_menu:notifications'),
  m.callbackButton('📖 View Bot Help', 'settings_menu:view_help'),
  m.callbackButton('⬅️ Back', 'settings_menu:backBtn')
], {columns: 1}));
...
.HTML()
.markup((m) => m.inlineKeyboard([
  m.callbackButton('⚙️ Manage Events', 'events_menu:manage_events'),
  m.callbackButton('🍴 View Events', 'events_menu:view_events'),
  m.callbackButton('⬅️ Back', 'events_menu:backBtn')
], {columns: 1}));
...
.HTML()
.markup((m) => m.inlineKeyboard([
  m.callbackButton('🛎 Add Event', 'manage_events_menu:add_event'),
  m.callbackButton('📖 Delete Event', 'manage_events_menu:delete_event'),
  m.callbackButton('⬅️ Back', 'manage_events_menu:backBtn')
], {columns: 1}));
...
.HTML()
.markup((m) => m.inlineKeyboard([
  m.callbackButton('🍴 All Events', 'view_events_menu:all_events'),
  m.callbackButton('🏀 Outings', 'view_events_menu:outings'),
  m.callbackButton('🎂 Birthdays', 'view_events_menu:birthdays'),
  m.callbackButton('⛅️ Others', 'view_events_menu:others_event'),
  m.callbackButton('⬅️ Back', 'view_events_menu:backBtn')
], {columns: 1}));
